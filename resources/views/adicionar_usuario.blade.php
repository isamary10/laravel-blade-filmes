        ...
        <div class="container">
            ...
            <form class="card card-sm" id="adicionar-usuario" name="adicionar-usuario" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="password_confirmation" id="password"/>
                    @error('password')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="password_confirmation" id="confirm-password"/>
                </div>
            </div>
